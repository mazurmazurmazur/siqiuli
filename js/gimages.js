! function t(e, i, n) {
    ...
    1: [function(t, e, i) {
        ! function(i, n) {
            ...
            function r(t, e, i) {
                ...
                "string" == typeof t && (t = document.querySelectorAll(t)), this.elements = o(t), this.options = n({}, this.options), "function" == typeof e ? i = e : n(this.options, e), i && this.on("always", i), this.getImages(), a && (this.jqDeferred = new a.Deferred);
                var s = this;
                setTimeout(function() {
                    s.check()
                })
    ...
    2: [function(t, e, i) {
        ! function(t) {
            ...
            var s = document.documentElement,
                o = function() {};
            s.addEventListener ? o = function(t, e, i) {
                t.addEventListener(e, i, !1)
            } : s.attachEvent && (o = function(t, e, i) {
            ...
            var r = function() {};
            s.removeEventListener ? r = function(t, e, i) {
                t.removeEventListener(e, i, !1)
            } : s.detachEvent && (r = function(t, e, i) {
        ...
        (function() {
            ...
            s.getListeners = function(t) {
                ...
                var n, s = this.getListenersAsObject(t),
                    o = "object" == typeof e;
                for (n in s) s.hasOwnProperty(n) && -1 === i(s[n], e) && s[n].push(o ? e : {
                    listener: e,
                    once: !1
                });
                return this
                ...
                var i, n, s, o, r, l = this.getListenersAsObject(t);
                for (o in l)
                    if (l.hasOwnProperty(o))
                        for (i = l[o].slice(0), s = i.length; s--;) n = i[s], n.once === !0 && this.removeListener(t, n.listener), r = n.listener.apply(this, e || []), r === this._getOnceReturnValue() && this.removeListener(t, n.listener);
                return this
    ...
    4: [function(t, e, i) {
        ! function(t, n) {
            ...
            function t(t, e, i) {
                ...
                return e && "object" == typeof e ? e.forEach(function(t) {
                    n.classList.add(t)
                }) : n.classList.add(e), n
            }

            function e() {
                for (var e = t("div", n.CONTROLS), i = t("button", n.CONTROLS_CLOSE), l = t("button", [n.CONTROLS_ARROW, n.CONTROLS_NEXT]), h = t("button", [n.CONTROLS_ARROW, n.CONTROLS_PREV]), a = [i, l, h], u = 0; u < a.length; u++) e.appendChild(a[u]);
            ...
            var i = {},
                ...
                r = '<svg fill="#FFFFFF" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M0 0h24v24H0z" fill="none"/><path d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"/></svg>';
            return i.init = e, i
        })
    }, {}],
    5: [function(t, e, i) {
    ...
    7: [function(t, e, i) {
        ! function(t, n) {
            "function" == typeof define && define.amd ? define(function() {
                return n(t)
            }) : "object" == typeof i ? e.exports = n : t.GoogleImageLayout = n(t)
        }(this, function(t) {
            "use strict";
            var e = {},
                i = [],
                ...
                r = function(t, e) {
                    i.push(e);
                    for (var n, s = 0; s < t.length; s++) n = t[s], n.style.width = e * parseInt(n.getAttribute("data-width")) / parseInt(n.getAttribute("data-height")) + "px", n.style.height = e + "px", n.classList.add("layout-completed")
                };
